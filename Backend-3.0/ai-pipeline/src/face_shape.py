...
class FaceMetrics:
    ...
    # Fitur tambahan hasil eksperimen kalibrasi (lihat catatan di classify_face_shape):
    # menaikkan cross-validation accuracy dari ~50% ke ~60% (Random Forest) / ~47%
    # ke ~51% (decision tree deterministik yang dipakai di produksi).
    jaw_angle_deg: float
    jaw_curvature: float
