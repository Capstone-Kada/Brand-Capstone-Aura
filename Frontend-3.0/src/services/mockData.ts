...
export const MOCK_TESTIMONIALS = [
  {
    ...
    quote: 'Before Aura, my Linktree CTR was 1.8%. After setting up my AI Selfie Scan, my followers instantly buy the exact foundation shade match. My monthly affiliate earnings tripled from Rp 31.5 Juta to Rp 117 Juta!',
  ...
  },
  {
    ...
    growth: 'Rp 213 Juta Earned Last Month'
  }
];
